...
const contentfulEnvNock = nock('https://api.contentful.com/')
  .defaultReplyHeaders({ 'Content-Type': 'application/json' })
...
const contentfulGetEntriesNock = nock('https://api.contentful.com/')
  .defaultReplyHeaders({ 'Content-Type': 'application/json' })
  .get(
...
const contentfulGetSingleEntryNock = nock('https://api.contentful.com/')
  .defaultReplyHeaders({ 'Content-Type': 'application/json' })
  .get(
...
const updateContentfulEntryNock = nock('https://api.contentful.com/')
  .defaultReplyHeaders({ 'Content-Type': 'application/json' })
  .put(
    `/spaces/${CONTENTFUL_SPACE}/environments/master/entries/2C3au2K5VaQiyOeowekkM4`,
    {
...
const publishUpdatedEntryNock = nock('https://api.contentful.com/')
  .defaultReplyHeaders({ 'Content-Type': 'application/json' })
  .put(
